      ...
      <div class="l-inner">
        <form class="p-reservation-form js-anim" action="reservation_send.php" method="post" autocomplete="on">
          ...
          <div class="p-reservation-grid">
            <div class="p-reservation-field"><label for="preferred_date">希望日<span class="p-reservation-required">必須</span></label><input type="date" id="preferred_date" name="preferred_date" min="<?php echo htmlspecialchars($today, ENT_QUOTES, 'UTF-8'); ?>" required></div>
